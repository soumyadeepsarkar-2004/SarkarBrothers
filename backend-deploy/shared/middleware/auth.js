...
export const generateToken = (
    ...
    // Auto-detect and swap if expiresIn is used to pass the secret key
    if (typeof expiresIn === 'string' && !expiresIn.match(/^\d+[smhdw]$/) && !Number.isInteger(Number(expiresIn))) {
        finalSecret = expiresIn;
        finalExpiresIn = '7d';
    }
